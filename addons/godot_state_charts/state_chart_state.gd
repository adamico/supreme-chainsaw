...
signal physics_state_processing(delta:float)
...
func _process(delta:float) -> void:
	...
	physics_state_processing.emit(delta)
...
func _toggle_processing(freeze:bool = false):
	...
	set_process(enable_processing and (_has_connections(physics_state_processing) or _pending_transition != null))
